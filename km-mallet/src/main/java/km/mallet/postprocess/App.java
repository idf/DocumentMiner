...
public class App {
	...
	public static void main(String[] args) throws IOException {
		File keysFile = new File(Setting.MalletSetting.ROOT_FOLDER, "keys_50.txt");
		File topicsFile = new File(Setting.MalletSetting.ROOT_FOLDER, "topics_50.txt");
		File weightsFile = new File(Setting.MalletSetting.ROOT_FOLDER, "topic_word_weights_50.txt");
		File countsFile = new File(Setting.MalletSetting.ROOT_FOLDER, "word_topic_counts_50.txt");
...
//		JSONUtil.save(terms, "E:/project/kd/data/topic/term_topics.json");
		...
		JsonWriter.saveList(terms, Setting.TopicSetting.TERMS_PATH);
	}
}
