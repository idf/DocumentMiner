...
public class DataImportUnigram {
	...
	public static void main(String[] args) throws IOException {
        ...
        File extraStopwordFile = new File(Config.settings.getMalletSettings().getRootFolder(), "stoplist/en.txt");
		File outputFile = new File(Config.settings.getMalletSettings().getPostsMalletPath());
