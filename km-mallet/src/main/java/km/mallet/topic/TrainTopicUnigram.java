...
public class TrainTopicUnigram {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFile = Setting.MalletSetting.POSTS_MALLET_PATH;
		int numTopics = Setting.MalletSetting.TOPIC_CNT; // 50
		String topicKeysFile = Setting.MalletSetting.KEYS_PATH; // Setting.MalletSetting.ROOT_FOLDER + numTopics + "_keys.txt";
		String docTopicsFile = Setting.MalletSetting.TOPICS_PATH; // Setting.MalletSetting.ROOT_FOLDER + numTopics + "_topics.txt";
